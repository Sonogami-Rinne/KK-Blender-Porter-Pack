...
class PlaceholderProperties(PropertyGroup):
    ...
    use_rigify : BoolProperty(
        ...
        default = bpy.context.preferences.addons[__package__].preferences.use_rigify)
    ...
    atlas_dropdown : EnumProperty(
        ...
        ), name="", default=bpy.context.preferences.addons[__package__].preferences.atlas_dropdown, description=t('use_atlas_tt'))
